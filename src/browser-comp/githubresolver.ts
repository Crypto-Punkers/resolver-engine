...
import { BrowserCompatibleUrlResolver, ResolverContext, SubResolver } from "..";
...
export function BrowserCompatibleGithubResolver(): SubResolver {
  const urlResolver = BrowserCompatibleUrlResolver();
