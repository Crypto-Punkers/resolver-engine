const data = [
  ...
  ["ledzeppelin/othercontract.sol", {"cwd": "/eth/installed_contracts"}, "/eth/installed_contracts/ledzeppelin/othercontract.sol"],
  ["ledzeppelin/othercontract.sol", {"cwd": "/eth/someproject"}, "/eth/installed_contracts/ledzeppelin/othercontract.sol"],
